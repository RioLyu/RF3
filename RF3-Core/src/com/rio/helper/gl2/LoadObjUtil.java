...
public class LoadObjUtil 
{
    ...
    /**
     * 从obj文件中加载携带顶点信息的物体，并自动计算每个顶点的纹理坐标
     * @param in
     * @return
     */
    public static float[][] load(InputStream in)
    {
     ...
     * @return
     */
    public static float[][] loadOnlyAverage(InputStream in)
    {
...
/*		    size=altResult.size();
     ...
     * @return
     */
    public static float[][] loadOnlyFace(InputStream in)
    {
    	float [][] info=new float[3][]; 	
